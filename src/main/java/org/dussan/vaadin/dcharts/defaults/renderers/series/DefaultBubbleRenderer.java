...
public class DefaultBubbleRenderer {
	...
	public static final Float AUTOSCALE_MULTIPLIER = 1.0f;
	public static final Float AUTOSCALE_POINTS_FACTOR = -0.07f;
	...
	public static final Float BUBBLE_ALPHA = 1.0f;
