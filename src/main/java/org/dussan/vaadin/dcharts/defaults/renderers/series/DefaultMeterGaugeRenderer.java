...
public class DefaultMeterGaugeRenderer {
	...
	public static final Float[] TICKS = {};
	...
	public static final Float[] INTERVALS = {};
	public static final String[] INTERVAL_COLORS = { "#4bb2c5", "#EAA228",
			"#c5b47f", "#579575", "#839557", "#958c12", "#953579", "#4b5de4",
			"#d8b83f", "#ff5800", "#0085cc", "#c747a3", "#cddf54", "#FBD178",
			"#26B4E3", "#bd70c7" };
	...
	public static final Float[] TICK_POSITIONS = { 1f, 2f, 2.5f, 5f, 10f };
	...
	public DefaultMeterGaugeRenderer() {
	}
