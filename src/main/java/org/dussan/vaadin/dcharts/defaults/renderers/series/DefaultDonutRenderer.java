...
public class DefaultDonutRenderer {

	public static final Integer DIAMETER = null;
	public static final Integer INNER_DIAMETER = null;
	public static final Integer THICKNESS = null;
	public static final Integer PADDING = 20;
	public static final Integer SLICE_MARGIN = 0;
	public static final Integer RING_MARGIN = null;
	...
	public static final DataLabels DATA_LABELS = DataLabels.PERCENT;
	...
	public static final Float DATA_LABEL_POSITION_FACTOR = 0.4f;
	public static final Integer DATA_LABEL_NUDGE = 0;
	public static final Integer START_ANGLE = 0;

	public DefaultDonutRenderer() {
	}
