...
public class DefaultLinearAxisRenderer {

	// EXPERIMENTAL
	// public static final Integer[] BREAK_POINTS = null;
	// EXPERIMENTAL
	// public static final String BREAK_TICK_LABEL = "&asymp;";
